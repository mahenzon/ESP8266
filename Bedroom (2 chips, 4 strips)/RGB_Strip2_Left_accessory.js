...
var options = {
  port: 1883,
  host: MQTT_IP,
  clientId: 'RGB_Strip2L'  // name to be introduced for MQTT broker
};

const mqttPrefixColor = 'cl';
const mqttPrefixPower = 'pl';
...
var LightController = {
  name: "RGB Strip 2 Left", //name of accessory
  pincode: "031-45-154", // password to add HomeKit device. You can change numbers keeping '-' symbols
  username: "CC:AA:AA:AA:AA:AA", // MAC like address used by HomeKit to differentiate accessories.
