...
var lightTopic = '/home/RGBLight';  // MQTT topic to publish updates

var options = {
  port: 1883,
  host: MQTT_IP,
  clientId: 'RGB_Strip_0'  // name to be introduced for MQTT broker
};
...
var LightController = {
  name: "RGB Strip", //name of accessory
  pincode: "111-11-111", // password to add HomeKit device. You can change numbers keeping '-' symbols
  username: "AB:CD:EF:AB:CD:1A", // MAC like address used by HomeKit to differentiate accessories.
...
// As we need to control RGB light and iOS sends color in HSB (HSV) format, we need to convert it.
      ...
      toPublish = 'c' + formatNumberLength(red) + ',' + formatNumberLength(green) + ',' +  formatNumberLength(blue);
